  ...
  return (
    ...
    >
      <div className="relative max-w-3xl text-center text-white auto lg:px-0">
        ...
        <h2 className="text-left p-4 text-gray-500 xl:text-xl">
          {`Grinler provides a user-friendly platform for efficient meme creation and collaboration, centralizing the process and offering new revenue opportunities through premium features and advertising. Empowering creative and humorous expression.`}
        </h2>
      </div>
    </section>
  );
