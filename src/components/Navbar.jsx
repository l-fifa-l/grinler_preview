      ...
      >
        <div className="relative flex items-center justify-between">
          ...
          <ul className=" items-center hidden space-x-8 lg:flex">
            ...
            <span className="lg:ml-3.5 space-x-4 flex">
              <i>
                <FaApple className="h-6 w-6 hover:text-[#F02E65]" />
              </i>
              <i>
                <DiAndroid className="h-6 w-6 hover:text-[#F02E65]" />
              </i>
            </span>
          </ul>
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full">
                <div className="p-5 bg-[#00D3CA] border rounded shadow-sm">
